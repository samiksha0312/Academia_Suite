    ...
    >
      <Container>
        ...
        <h2 className="text-center mb-4 fw-bold">
          About <span className="text-primary">Acadimica Suite</span>
        </h2>
        <p className="text-center text-muted mb-5">
          Acadimica Suite is a comprehensive and modern college management platform
          ...
          and secure data handling, Acadimica Suite empowers institutions to embrace
